...
For SymbolLinking support, download [SAMPLEWEBTRADINGAPP-95U8.ELD](https://github.com/frankts/tradestation-web-tradingapp-sample/blob/master/SAMPLEWEBTRADINGAPP-95U8.ELD?raw=true). You must have TradeStation 9.5 Update 8 or greater for this sample to work. To help illustrate SymbolLinking, please download [SAMPLEWEBTRADINGAPP-95U8.TSW](https://github.com/frankts/tradestation-web-tradingapp-sample/blob/master/SAMPLEWEBTRADINGAPP-95U8.TSW?raw=true) workspace and open it in the platform.
